...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns requests artist to @artist and renders the show template" do
      artist = create(:artist)
  ...
  describe "GET #edit" do
    it "assigns requested artist to @artist and renders the edit template" do
      artist = create(:artist)
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns newly created artist to @artist" do
        post :create, { :artist => attributes_for(:artist) }
        expect(assigns(:artist)).to be_a(Artist)
        expect(assigns(:artist)).to be_persisted
      end

      it "redirects to the created artist's page" do
        post :create, { :artist => attributes_for(:artist) }
    ...
    context "with invalid params" do
      it "assigns newly created but unsaved artist to @artist" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      it "updates the requested artist" do
        ...
        put :update, {:id => artist.id, :artist => attributes_for(:artist, name: "New name")}
      ...
      it "redirects to the artist's page" do
        artist = create(:artist)
    ...
    context "with invalid params" do
      it "assigns the artist to @artist" do
        ...
        put :update, {:id => artist.id, :artist => attributes_for(:artist, name: nil)}
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to artists page" do
      artist = create(:artist)
      delete :destroy, {:id => artist.to_param}
